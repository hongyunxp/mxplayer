...
/// map定义
typedef map<int,void *,greater<int> >			CPublicMapIntToPtr;
typedef map<long,void *,greater<long> >			CPublicMapLongToPtr;
typedef map<ULONG,void *,greater<ULONG> >		CPublicMapULongToPtr;
typedef map<string,void *,greater<string> >		CPublicMapStringToPtr;
typedef map<int, string, greater<int> >			CPublicMapIntToStr;
typedef map<string, string, greater<string> >	CPublicMapStringToString;
typedef map<string, int, greater<string> >		CPublicMapStrToInt;
